...
#  end
  ...
  describe ".to_s" do
    it "should return the discipline name" do 
      lessons(:trigonometry).to_s.should eql('Math')
    end
  end
  
  describe ".to_calendar" do 
    it "should return calendar_entry" do
      lessons(:trigonometry).to_calendar.should eql('18:00 - Math')
    end
  end
  
  describe ".color" do
    it "should return course color" do
      lessons(:trigonometry).color.should eql('12f5b9')
    end
  end
